...
export default class Logger {
  ...
  public readonly log = (...message: any[]) => this.output(Level.LOG, Color.WHITE, message);
  public readonly debug = (...message: any[]) => this.output(Level.DEBUG, Color.GREEN, message);
  public readonly info = (...message: any[]) => this.output(Level.INFO, Color.GREEN, message);
  public readonly warn = (...message: any[]) => this.output(Level.WARN, Color.YELLOW, message);
  public readonly error = (...message: any[]) => this.output(Level.ERROR, Color.RED, message);
